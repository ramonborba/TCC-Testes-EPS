...
\begin{alineas}
    ...
    \begin{alineas}
        ...
        \item o estágio de \textit{acceptance} visa demostrar que o modelo final \red{modelo físico de vôo} está em conformidade com o design qualificado préviamente
    \end{alineas}
